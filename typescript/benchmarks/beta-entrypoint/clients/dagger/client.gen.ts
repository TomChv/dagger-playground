 ...
 */
export function AgentMessageDeliveryValueToName(value: AgentMessageDelivery): string {
  switch (value) {
 ...
 */
export function AgentMessageDeliveryNameToValue(name: string): AgentMessageDelivery {
  switch (name) {
    case "QUEUED":
 ...
 * it can be uses as argument to call a exposed function.
 */
export function ChangesetMergeConflictValueToName(value: ChangesetMergeConflict): string {
  switch (value) {
 ...
 * it can be properly used inside the module runtime.
 */
export function ChangesetMergeConflictNameToValue(name: string): ChangesetMergeConflict {
  switch (name) {
    case "FAIL":
 ...
 * it can be uses as argument to call a exposed function.
 */
export function ChangesetsMergeConflictValueToName(value: ChangesetsMergeConflict): string {
  switch (value) {
 ...
 * it can be properly used inside the module runtime.
 */
export function ChangesetsMergeConflictNameToValue(name: string): ChangesetsMergeConflict {
  switch (name) {
    case "FAIL":
 ...
 * it can be uses as argument to call a exposed function.
 */
export function FunctionCachePolicyValueToName(value: FunctionCachePolicy): string {
  switch (value) {
 ...
 * it can be properly used inside the module runtime.
 */
export function FunctionCachePolicyNameToValue(name: string): FunctionCachePolicy {
  switch (name) {
    case "Default":
 ...
 * it can be uses as argument to call a exposed function.
 */
export function GitPushDispositionValueToName(value: GitPushDisposition): string {
  switch (value) {
 ...
 * it can be properly used inside the module runtime.
 */
export function GitPushDispositionNameToValue(name: string): GitPushDisposition {
  switch (name) {
    case "CREATED":
 ...
 * it can be uses as argument to call a exposed function.
 */
export function LLMMessageOriginKindValueToName(value: LLMMessageOriginKind): string {
  switch (value) {
 ...
 * it can be properly used inside the module runtime.
 */
export function LLMMessageOriginKindNameToValue(name: string): LLMMessageOriginKind {
  switch (name) {
    case "AGENT":
 ...
 * it can be uses as argument to call a exposed function.
 */
export function ModuleSourceExperimentalFeatureValueToName(value: ModuleSourceExperimentalFeature): string {
  switch (value) {
 ...
 * it can be properly used inside the module runtime.
 */
export function ModuleSourceExperimentalFeatureNameToValue(name: string): ModuleSourceExperimentalFeature {
  switch (name) {
    case "SELF_CALLS":
 ...
 * it can be uses as argument to call a exposed function.
 */
export function WorkspaceCommitPickReasonValueToName(value: WorkspaceCommitPickReason): string {
  switch (value) {
 ...
 * it can be properly used inside the module runtime.
 */
export function WorkspaceCommitPickReasonNameToValue(name: string): WorkspaceCommitPickReason {
  switch (name) {
    case "CONTENT":
 ...
 * it can be uses as argument to call a exposed function.
 */
export function WorkspaceCommitPickStatusValueToName(value: WorkspaceCommitPickStatus): string {
  switch (value) {
 ...
 * it can be properly used inside the module runtime.
 */
export function WorkspaceCommitPickStatusNameToValue(name: string): WorkspaceCommitPickStatus {
  switch (name) {
    case "CONFLICT":
...
export class Agent extends BaseClient {
   ...
   * @experimental
   */
  notify = async (subscriber: Agent, 
    opts?: AgentNotifyOpts): Promise<Agent> => {
    const ctx = this._ctx.select(
      "notify",
      { subscriber, ...opts},
    )
   ...
   */
  pause = async (
    opts?: AgentPauseOpts): Promise<Agent> => {
    const ctx = this._ctx.select(
      "pause",
      { ...opts},
    )
   ...
   */
  stop = async (
    opts?: AgentStopOpts): Promise<Agent> => {
    const ctx = this._ctx.select(
      "stop",
      { ...opts},
    )
...
export class Changeset extends BaseClient {
  ...
  withChangeset = (changes: Changeset, opts?: ChangesetWithChangesetOpts): Changeset => {
	const metadata = {
	    onConflict: { is_enum: true, value_to_name: ChangesetMergeConflictValueToName },
	}


    const ctx = this._ctx.select(
      "withChangeset",
      { changes, ...opts, __metadata: metadata },
    )
    return new Changeset(ctx)
  }
...
export class Container extends BaseClient {
  ...
  exists = async (path: string, 
    opts?: ContainerExistsOpts): Promise<boolean> => {
    if (this._exists) {
      return this._exists
    }
   ...
   * Defaults to OCI, which is largely compatible with most recent container runtimes, but Docker may be needed for older runtimes without OCI support.
   */
  exportImage = async (name: string, 
    opts?: ContainerExportImageOpts): Promise<void> => {
...
export class Directory extends BaseClient {
   ...
   */
  exists = async (path: string, 
    opts?: DirectoryExistsOpts): Promise<boolean> => {
    if (this._exists) {
      return this._exists
    }
   ...
   */
  search = async (
    opts?: DirectorySearchOpts): Promise<SearchResult[]> => {
    type search = {
      id: ID
    }
  ...
  withPatch = (patch: string, opts?: DirectoryWithPatchOpts): Directory => {
    ...
    const ctx = this._ctx.select(
      "withPatch",
      { patch, ...opts, __metadata: metadata },
    )
    return new Directory(ctx)
  }
...
export class EnvFile extends BaseClient {
  ...
  get = async (name: string, 
    opts?: EnvFileGetOpts): Promise<string> => {
    if (this._get) {
      return this._get
    }
   ...
   */
  variables = async (
    opts?: EnvFileVariablesOpts): Promise<EnvVariable[]> => {
    type variables = {
      id: ID
    }
...
export class File extends BaseClient {
   ...
   */
  contents = async (
    opts?: FileContentsOpts): Promise<string> => {
    if (this._contents) {
  ...
  search = async (pattern: string, 
    opts?: FileSearchOpts): Promise<SearchResult[]> => {
    type search = {
      id: ID
    }
...
export class Function_ extends BaseClient {
  ...
  withCachePolicy = (policy: FunctionCachePolicy, opts?: FunctionWithCachePolicyOpts): Function_ => {
    ...
    const ctx = this._ctx.select(
      "withCachePolicy",
      { policy, ...opts, __metadata: metadata },
    )
    return new Function_(ctx)
  }
...
export class GitRef extends BaseClient {
   ...
   */
  log = async (
    opts?: GitRefLogOpts): Promise<GitCommit[]> => {
    type log = {
      id: ID
    }
  ...
  withCommit = (changes: Changeset, message: string, date: string, authorName: string, authorEmail: string, opts?: GitRefWithCommitOpts): GitRef => {
    ...
    const ctx = this._ctx.select(
      "withCommit",
      { changes, message, date, authorName, authorEmail, ...opts },
    )
    return new GitRef(ctx)
  }
...
export class JSONValue extends BaseClient {
   ...
   */
  contents = async (
    opts?: JSONValueContentsOpts): Promise<JSON> => {
    if (this._contents) {
      return this._contents
    }
...
export class Client extends BaseClient {
  ...
  currentTypeDefs = async (
    opts?: ClientCurrentTypeDefsOpts): Promise<TypeDef[]> => {
  ...
  moduleSource = (refString: string, opts?: ClientModuleSourceOpts): ModuleSource => {
	const metadata = {
	    requireKind: { is_enum: true, value_to_name: ModuleSourceKindValueToName },
	}
   ...
   */
  serveModule = async (address: string, 
    opts?: ClientServeModuleOpts): Promise<void> => {
    const ctx = this._ctx.select(
      "serveModule",
      { address, ...opts},
    )
...
export class Workspace extends BaseClient {
   ...
   */
  compareCommitsFrom = async (source: Workspace, 
    opts?: WorkspaceCompareCommitsFromOpts): Promise<WorkspaceCommitPick[]> => {
   ...
   */
  findRoots = async (
    opts?: WorkspaceFindRootsOpts): Promise<string[]> => {
    const ctx = this._ctx.select(
      "findRoots",
      { ...opts},
    )
   ...
   */
  findUp = async (name: string, 
    opts?: WorkspaceFindUpOpts): Promise<string> => {
    if (this._findUp) {
      return this._findUp
    }
   ...
   */
  search = async (
    opts?: WorkspaceSearchOpts): Promise<SearchResult[]> => {
    type search = {
      id: ID
    }
